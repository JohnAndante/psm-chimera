...
import { NotificationChannelType, type CreateNotificationChannelData, type TelegramConfig, type EmailConfig, type WebhookConfig, type TelegramAllowedUser } from "@/types/notification-channel";
...
export function CreateChannelPage() {
    ...
    const onSubmit = async (data: CreateChannelFormData) => {
        ...
        try {
            ...
            await notificationChannelsApi.create(channelData);

            toast.success("Canal criado com sucesso", {
                description: `O canal "${data.name}" foi criado e está pronto para uso.`
            });

            navigate('/canais-notificacao');
        } catch (error: unknown) {
            // Tratar erros de validação da API
            let errorMessage = "Não foi possível criar o canal.";
    ...
    return (
        <PageContainer
            ...
            subtitle="Configure um novo canal para receber notificações do sistema"
            breadcrumbs={[
                                            ...
                                            <FormItem>
                                                ...
                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                    ...
                                                    <SelectContent>
                                                        ...
                                                        {/* <SelectItem value={NotificationChannelType.WEBHOOK}>Webhook</SelectItem> */}
                                                    </SelectContent>
                                                </Select>
                                                <FormMessage />
                                            </FormItem>
